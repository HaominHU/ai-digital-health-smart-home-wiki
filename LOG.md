...
## [2026-07-02] workflow | Reinforced preview approval gate and lint cleanup

- Summary: Resolved minor health-check findings by adding missing citation-memory links to three dementia evidence pages, updating stale preview source paths after source-lane reorganization, and reinforcing that major-source previews require explicit user review before maintained-wiki integration.
- Files touched: `AGENTS.md`, `README.md`, `MEMORY.md`, `wiki/workflows/ingest_source.md`, `wiki/commands/ingest_source.md`, `wiki/evidence/cheng_2020_meta_review_dementia_caregiver_interventions.md`, `wiki/evidence/bressan_2020_dementia_caregiver_needs_mixed_method_review.md`, `wiki/evidence/ruggiano_2021_chatbots_dementia_caregivers.md`, `outputs/ingest_previews/`, `LOG.md`.
- Notes: The monthly PubMed topic folders remain provisional and should be revised when future papers repeatedly conflict with the current taxonomy. Preview artifacts remain local-only by default.

## [2026-07-02] architecture | Organized monthly PubMed source lane

- Summary: Reorganized `sources/papers/monthly_pubmed/` from a flat lane into provisional topic-lens subfolders: `adoption_preferences_and_equity/`, `ai_interaction_and_decision_support/`, `caregiving_support_systems/`, and `smart_home_and_ambient_care/`.
- Files touched: `sources/papers/monthly_pubmed/`, `AGENTS.md`, `README.md`, `INDEX.md`, `MEMORY.md`, `wiki/workflows/ingest_source.md`, `wiki/overview/domain_map.md`, `wiki/evidence/kingsada_2026_preferences_digital_health_technologies.md`, `wiki/references/items/2026_kingsada_preferences-digital-health-technologies.md`, `LOG.md`.
- Notes: Taxonomy is provisional and should be revised when future monthly PubMed papers repeatedly conflict with the current categories. Kingsada 2026 was moved under `adoption_preferences_and_equity/`.

## [2026-07-02] ingest | Monthly PubMed AI, smart-home, and caregiver telehealth papers

- Summary: Integrated three high-value full-text monthly PubMed papers: Chen and Jin 2026 on GenAI as interactional infrastructure for meaning-centered care in later life, Zhai et al. 2026 on smart home technologies for ageing in place, and Mahmood et al. 2026 on telehealth utilization among middle-aged and older informal caregivers.
- Files touched: `sources/papers/monthly_pubmed/ai_interaction_and_decision_support/2026-06-16_chen_generative-ai-meaning-centered-care-later-life.pdf`, `sources/papers/monthly_pubmed/smart_home_and_ambient_care/2026-06-24_zhai_smart-home-technologies-ageing-in-place_full-text.xml`, `sources/papers/monthly_pubmed/caregiving_support_systems/2026-06-16_mahmood_telehealth-informal-caregivers.pdf`, `outputs/ingest_previews/2026-07-02_chen_generative-ai-meaning-centered-care-later-life_preview.md`, `outputs/ingest_previews/2026-07-02_zhai_smart-home-technologies-ageing-in-place_preview.md`, `outputs/ingest_previews/2026-07-02_mahmood_telehealth-informal-caregivers_preview.md`, `wiki/evidence/chen_2026_generative_ai_meaning_centered_care_later_life.md`, `wiki/evidence/zhai_2026_smart_home_technologies_ageing_in_place.md`, `wiki/evidence/mahmood_2026_telehealth_informal_caregivers.md`, `wiki/references/items/2026-06-16_chen_generative-ai-meaning-centered-care-later-life.md`, `wiki/references/items/2026-06-24_zhai_smart-home-technologies-ageing-in-place.md`, `wiki/references/items/2026-06-16_mahmood_telehealth-informal-caregivers.md`, `wiki/technologies/ai_driven_digital_health.md`, `wiki/technologies/smart_home_technologies.md`, `wiki/populations/family_caregivers.md`, `wiki/populations/older_adults.md`, `wiki/caregiving_challenges/care_coordination_and_shared_access.md`, `wiki/caregiving_challenges/monitoring_and_safety_awareness.md`, `wiki/care_recipient_needs/autonomy_privacy_and_dignity.md`, `wiki/design_patterns/person_and_family_centered_care_coordination.md`, `wiki/design_patterns/retrieval_grounded_health_ai_support.md`, `wiki/environments/home.md`, `wiki/overview/caregiver_system_core_sota_synthesis.md`, `INDEX.md`, `MEMORY.md`, `LOG.md`.
- Notes: Source types are journal perspective, systematic review, and cross-sectional survey study; evidence type is published evidence; privacy level is private/non-sensitive. Citation-memory records are RIS export-ready. Chen is conceptual framework evidence, Zhai is heterogeneous systematic-review evidence, and Mahmood is caregiver telehealth utilization evidence rather than telehealth intervention-effectiveness evidence. Smart-home PDF retrieval was blocked; the source was saved as PMC full-text XML instead.
